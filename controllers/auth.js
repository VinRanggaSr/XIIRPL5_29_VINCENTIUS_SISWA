...
const signin = async (req, res) => {
  ...
  const token = jwt.sign({ id: table.id }, config.secret, {
    algorithm: "HS256", // enkripsi token
    allowInsecureKeySizes: true,
    expiresIn: 86400, // 24 hours sbgi batas waktu. Sehingga jika lebih dari waktu itu harus login lagi
  });
